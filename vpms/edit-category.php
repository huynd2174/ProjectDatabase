...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    <head>
        ...
        <title>Quản lý các loại xe</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-category.php">Loại xe</a></li>
                                    <li class="active">Cập nhật loại xe</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">Tên loại xe</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="catename" name="catename"
                                                    class="form-control" placeholder="Loại phương tiện" required="true"
