                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="search-vehicle.php">Tìm phương tiện</a></li>
                                    <li class="active">Tìm phương tiện</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tìm phương tiện</strong>
                        </div>
                        <div class="card-body">
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tìm phương tiện dựa trên mã đỗ xe </label></div>
